...
Now that the file system has been created, you need to add another parameter store value for the file system ID so that the automatically automatically built instance(s) can load this safely.
